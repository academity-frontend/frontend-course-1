...
**[Presentation 1](presentations/presentation-5-images-1.pdf)**<br />
**[Presentation 2](presentations/presentation-5-images-2.pdf)**<br />
**[Manual](manuals/manual-5-images.pdf)**<br /> 

**Video:** <br />
**[Part 1:](https://drive.google.com/file/d/1HmQVsrrjAem4xPcZT6N4fNfVHCXK7dtW/view?usp=sharing)**<br />
**[Part 2:](https://drive.google.com/file/d/1CYEraWlHFKpJOKVeJp9zCa27uuhGXcZG/view?usp=sharing)**<br />

# Homework
1. Export all images from the Figma mockup in suitable formats:
    - jpg/png → convert to webp
    - svg 
2. Optimise raster images. You can use Squoosh  or other services.
3. Insert images into your markup, using the appropriate method of insertion:
    - `<img>` and `<picture>` for content images
    - `background-image` for decorative images
    - `svg` in HTML code or background
4. Add alt text in `<img>` tags. 
5. Add basic sizes: width and height, in `<img>` tags. 
